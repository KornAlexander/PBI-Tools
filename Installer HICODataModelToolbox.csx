                    ...
                    "Backup and Append Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
{
    ...
    try
    {
        ...
        else if (File.Exists(desktopBackupMacroActionsFile))
        {
            ...
            MessageBox.Show("Adding the HICO-Group Data Model Toolbox was successful. (The MacroActions.json was copied from the desktop to appdata.)", "Operation Summary", MessageBoxButtons.OK, MessageBoxIcon.Information);
            return;
        }
        else
        {
        ...
        ? "Operation Successful: The HICO-Group Data Model Toolbox was added successfully to your existing Macros. (Macros in HICODataModelToolbox.txt appended to MacroActions.json.)" 
            : "Operation failed.";
